        ...
        info = @Info(
                ...
                extensions = {
                        @Extension(properties = {
                                @ExtensionProperty(name = "name", value = "watertank"),
                                @ExtensionProperty(name = "context", value = "/watertank"),
                        })
                }
        ),
        tags = {
                @Tag(name = "watertank", description = "")
        }
)
@Scopes(
        scopes = {
                @Scope(
                        name = "Enroll device",
                        description = "",
                        key = "perm:watertank:enroll",
                        permissions = {"/device-mgt/devices/enroll/watertank"}
                )
        }
)
...
public interface DeviceTypeService {
    ...
    @ApiOperation(
            ...
            extensions = {
                    @Extension(properties = {
                            @ExtensionProperty(name = SCOPE, value = "perm:watertank:enroll")
                    })
            }
    )
