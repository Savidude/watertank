...
package org.wso2.watertank.api;

import org.wso2.watertank.api.dto.DeviceJSON;
import org.wso2.watertank.api.dto.SensorRecord;
import org.wso2.watertank.api.util.APIUtil;
import org.wso2.watertank.api.util.ZipUtil;
import org.wso2.watertank.api.util.ZipArchive;
import org.wso2.watertank.plugin.constants.DeviceTypeConstants;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "watertank"));
            APIUtil.getDeviceManagementService().addOperation("watertank", commandOp,
                                                              deviceIdentifiers);
