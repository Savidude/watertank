...
package org.wso2.watertank.plugin.constants;
...
public class DeviceTypeConstants {
    ...
    public static final String SENSOR_TYPE1_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_watertank";
    public static final String SENSOR_TYPE2_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_a";
    public static final String DATA_SOURCE_NAME = "jdbc/watertankDM_DB";
    public final static String DEVICE_TYPE_PROVIDER_DOMAIN = "carbon.super";
    public final static String SENSOR_TYPE1 = "watertank";
    public final static String SENSOR_TYPE2 = "a";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/watertank/+/watertank";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.watertank";
    public final static String SENSOR_TYPE1_STREAM_DEFINITION_VERSION = "1.0.0";

    public final static String SENSOR_TYPE2_STREAM_DEFINITION = "org.wso2.iot.devices.a";
